    ...
    <main class="h-screen flex flex-col lg:flex-row">
        ...
        <div class="w-full bg-gray-100 px-4 py-8 h-full overflow-y-scroll">
            ...
            <div class="flex items-start">
                <div class="w-14 h-96 relative mr-4 hidden lg:inline-block">
                    <!-- X Scale -->
                    <h6 class="transform -rotate-90 absolute top-2/4 text-sm">Volumes</h6>
                </div>
            ...
            <script>
                ...
                async function showGraph() {
                    try {
                        ...
                        console.log(data);
                        for (let i in data) {
                            months.push(data[i].name);
                            hits.push(data[i].score);
                        }
